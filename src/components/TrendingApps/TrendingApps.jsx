    ...
    return (
        <div className='max-w-[1435px] mx-3 lg:mx-auto'>
            <div className='text-center mt-10 lg:mt-20'>
                ...
                <p className="text-[#627382] text-xl mt-3">Explore All Trending Apps on the Market developed by us</p>
                <div className="grid grid-rows-1 lg:grid-cols-4 gap-4 mt-5 lg:mt-10">
                    {
                    homeData.map(apps => <Trending key={apps.id} apps={apps}></Trending>)
                }
                </div>
                <NavLink to="/apps">
