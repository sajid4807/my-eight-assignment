...
import { addStoreBd, getInstallApp } from "../utility/addToBD";
...
const AppDetails = () => {
  ...
  const sortedRatings = [...singleApp.ratings].sort((a, b) => {
    const rating = (str) => parseInt(str.split(" ")[0], 10);
    return rating(b.name) - rating(a.name);
  });
    ...
    <div className="max-w-[1435px] my-10 lg:my-20 mx-3 lg:mx-auto">
      <div className="flex flex-col lg:flex-row pb-4 items-center border-b border-[#001931]/20 mb-10">
        <figure className="h-[350px]">
          <img
            className="w-[350px] h-[350px] bg-base-100 shadow-sm"
            src={image}
            alt=""
          />
        </figure>
        <div className="lg:card-body">
          <div className="border-b border-[#001931]/20 pb-4 lg:pb-7">
            <h2 className="text-[#001931] text-3xl font-bold mt-3 lg:mt-0 mb-1">
              {title}
            </h2>
          ...
          <div className="flex gap-5 lg:gap-12 my-4 lg:my-8">
            <div>
              ...
              <p className="text-[#001931]/80 text-lg lg:text-xl my-1">
                Downloads
              </p>
              <h3 className="text-[#001931] text-2xl lg:text-5xl font-bold">
                {downloads}
              </h3>
            </div>
            <div>
          ...
          <div className="card-actions">
            <button
              disabled={install}
              onClick={() => handelInstallClick(id)}
              className={`btn ${
                install ? " text-black" : "bg-[#00D390] text-white"
              }`}
            >
        ...
        <div className="border-b border-[#001931]/20 pb-3 mb-10">
          <ResponsiveContainer width="100%" height={350}>
            ...
            >
              ...
              <Tooltip />
              <Bar dataKey="count" fill="#00D390" barSize={25} />
              <Bar dataKey="name" fill="#00D390" barSize={25} />
            </BarChart>
          </ResponsiveContainer>
        </div>
        <div>
